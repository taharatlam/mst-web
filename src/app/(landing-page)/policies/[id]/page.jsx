...
const PrivacyPolicy = () => {
  return (
    <>
        ...
        <section className="privacy-content-sec sec">
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <div className="privacy-content-box">
                            ...
                            <p className="">
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Necessitatibus architecto, amet officia temporibus vitae culpa provident. Necessitatibus quas aut molestiae? Magnam quo amet exercitationem consequuntur. Vero laudantium dolorem labore praesentium.
                            </p>
                            <ul>
